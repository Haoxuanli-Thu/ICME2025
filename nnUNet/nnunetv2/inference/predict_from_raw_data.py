...
# import medcam.medcam_inject as medcam_inject
import numpy as np
import torch
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        # network.to("cuda:4")
        # network = medcam.inject(network, output_dir="/home/lihaoxuan/Project/3dMRIseg/dataset/atten_map", save_maps=True)
    ...
    def _internal_maybe_mirror_and_predict(self, x: torch.Tensor) -> torch.Tensor:
        ...
        #         class_loss = model_output[0, target_class].sum()
        ...
        # # 使用示例
        # def apply_gradcam_3d(model, input_image, target_class, target_layer):
        ...
        # import os
        # self.network.train()
        # cam = apply_gradcam_3d(self.network, x, 1, self.network.decoders[-1])

        # # 指定保存路径 
        # save_dir = '/home/lihaoxuan/Project'
        # os.makedirs(save_dir, exist_ok=True)

        # # 绘制图像
        # plt.figure()
        # plt.imshow(cam[cam.shape[0]//2], cmap='jet')
        # plt.colorbar()
        # plt.title('Grad-CAM for 3D Medical Image Segmentation')
    ...
    def predict_sliding_window_return_logits(self, input_image: torch.Tensor) \
        ...
        with torch.no_grad():
            ...
            # self.network = medcam.inject(self.network, output_dir="/home/lihaoxuan/Project/3dMRIseg/dataset/atten_map",label=1,replace=True,backend="gcam",layer='encoders.0')
...
def predict_entry_point_modelfolder():
    ...
    parser.add_argument('-f', nargs='+', type=str, required=False, default=(0, 1, 2, 3, 4),
                        help='Specify the folds of the trained model that should be used for prediction. '
                             'Default: (0, 1, 2, 3, 4)')
    parser.add_argument('-step_size', type=float, required=True, default=0.5,
...
def predict_entry_point():
    ...
    parser.add_argument('-f', nargs='+', type=str, required=False, default=(0, 1, 2, 3, 4),
                        help='Specify the folds of the trained model that should be used for prediction. '
                             'Default: (0, 1, 2, 3, 4)')
    parser.add_argument('-step_size', type=float, required=False, default=0.25,
                        help='Step size for sliding window prediction. The larger it is the faster but less accurate '
                             'the prediction. Default: 0.5. Cannot be larger than 1. We recommend the default.')
    parser.add_argument('--disable_tta', action='store_true', required=False, default=False,
                        help='Set this flag to disable test time data augmentation in the form of mirroring. Faster, '
...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        r"/home/lihaoxuan/Project/3dMRIseg/code/U-Mamba-main/data/nnUNet_test/Dataset500_Breast/nnUNetTrainerBaselinev5__nnUNetPlans__3d_fullres",
        use_folds=("all"),
        checkpoint_name='checkpoint_final.pth',
    )
    # predictor.predict_from_files(r"/home/lihaoxuan/Project/3dMRIseg/dataset/test_500/imagesTr",
    #                              r"/home/lihaoxuan/Project/3dMRIseg/dataset/test_500/labelsTr",
    ...
    img, props = SimpleITKIO().read_images([r"/home/lihaoxuan/Project/3dMRIseg/dataset/test_500/imagesTr/breast_0006_0000.nii.gz"])
